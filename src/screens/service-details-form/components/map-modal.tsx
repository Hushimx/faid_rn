...
const MapModal = forwardRef<IModalRef, IProps>(
  ({ onSelectLocation, initialLocation }, ref) => {
    const { t } = useTranslation();
    const { height } = useWindowDimensions();
    const [locationCoordinates, setLocationCoordinates] =
      useState<LatLng | null>(initialLocation || null);
    ...
    const handleLocationUpdate = useCallback((coordinates: LatLng) => {
